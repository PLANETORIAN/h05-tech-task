...
function Browse() {
    return (
        ...
        <h2 className="text-center text-2xl md:text-3xl font-[700] mb-6 md:mb-8 font-integral">
        ...
        <div className="flex overflow-hidden gap-3 md:gap-4">
          ...
          {styles.map((style, index) => {
            ...
            return (
                <div
                key={index}
                className={`shrink-0 ${colSpan} relative rounded-xl overflow-hidden bg-white shadow-sm group cursor-pointer`}
              >
